...
При связывании двух атомов, прооисходит формирование диммера. Диммер характеризуется положением в пространстве, которое определяется направляющим вектором между двумя атомами заданного типа (Направление кристаллической решётки). При рассчёте сайтов, единичный вектор переменожается на коэффициенты этого направляющего вектора.  
